...
#
# Or with options:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/flyzstu/openclaw-docker/main/install.ps1))) -NoStart
#
...
$RepoUrl = "https://github.com/flyzstu/openclaw-docker"
$ComposeUrl = "https://raw.githubusercontent.com/flyzstu/openclaw-docker/main/docker-compose.yml"
...
function Write-Banner {
    ...
    Write-Host "║                                                              ║" -ForegroundColor Red
    Write-Host "║              Docker Installer by Flyzstu                   ║" -ForegroundColor Red
    Write-Host "║                                                              ║" -ForegroundColor Red
    Write-Host "╚══════════════════════════════════════════════════════════════╝" -ForegroundColor Red
    Write-Host ""
}
